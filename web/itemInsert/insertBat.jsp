        ...
        <div class="infoTableRow">
            ...
            <div class="value">
                <form id="itemInfo" method="post" action="putIntoDB" enctype="multipart/form-data">
                    ...
                    <input type="text" name="instantaneousDischargeRate" class="inputText"
                           placeholder="瞬时放电倍率，单位：C"><br>
                    <input type="text" name="maxChargingRate" class="inputText" placeholder="最大充电倍率，单位：C"><br>
                    <input type="text" name="recommendedChargingCurrent" class="inputText"
                           placeholder="推荐充电电流,单位：A"><br>
